...
|---|---|
|**group 'by'**|---|
|_writing 'by=' is optional_flights[  ,  .N,  by=origin  ]<br/>flights[  ,  .N,  by=.(origin)  ]<br/>flights[  ,  .N,  by=.(origin, dest)  ]<br/>flights[  ,  .N,  by=.(dep_delayed = dep_delay>0, arr_delayed = arr_delay>0)  ]|---|
|---|---|
|**Combined Operation**|---|
